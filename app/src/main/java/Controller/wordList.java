...
public class wordList {
    ...
    static {
        ...
        wordList.put(14, new String[] {"chien", "chien"});
        ...
        wordList.put(19, new String[] {"coer", "heart"});
        ...
        wordList.put(25, new String[] {"mere", "mother"});
        wordList.put(26, new String[] {"merci", "thank you"});
        wordList.put(27, new String[] {"soer", "sister"});
        ...
        wordList.put(53, new String[] {"ecrit", "write"});
        wordList.put(54, new String[] {"parle", "speak"});
        wordList.put(55, new String[] {"deja", "already"});
        wordList.put(56, new String[] {"nom", "name"});
        wordList.put(57, new String[] {"prenom", "firstname"});
        wordList.put(58, new String[] {"homme", "gentleman"});
        wordList.put(59, new String[] {"yaourt", "yoghurt"});
        ...
        wordList.put(93, new String[] {"portable", "mobile"});
        wordList.put(95, new String[] {"conjoint", "spouse"});
        wordList.put(96, new String[] {"beaucoup", "a lot"});
        wordList.put(97, new String[] {"disponible", "available"});
        wordList.put(94, new String[] {"au revoir", "bye"});
        wordList.put(98, new String[] {"bienvenue", "welcome"});
        wordList.put(99, new String[] {"promenade", "walk"});
        wordList.put(100, new String[] {"au'jour'd'hui", "today"});
    }
